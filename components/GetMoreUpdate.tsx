...
const GetMoreUpdate = () => {
  return (
    ...
    <div className='flex flex-col gap-6 text-white items-center justify-center'>
        ...
        <div className='w-[865px] h-[71px] rounded-[116px] bg-[#d9d9d9] flex justify-end items-center relative text-black'>
            <input type="text" placeholder='Your email..' className=' absolutepl-10 w-[865px]  rounded-l-[116px] h-full bg-[#d9d9d9] pl-10 focus:outline-none' />
